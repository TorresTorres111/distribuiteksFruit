...
let logoutAuto = document.querySelector( '#navLogout' );
...
languajeAuto.addEventListener( 'click', () => {
    ...
    if ( languaje == 'Español' ) {
        ...
        logoutAuto.innerHTML = 'Cerrar sesión';
    ...
    if ( languaje == 'Français' ) {
        ...
        logoutAuto.innerHTML = 'fermer la session';
